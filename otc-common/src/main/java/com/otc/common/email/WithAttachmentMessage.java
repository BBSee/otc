...
public class WithAttachmentMessage {
    ...
    public MimeMessage createMessage(Session session, MailContent mailContent) throws Exception {
        ...
        //设置自定义发件人昵称
        String nick = javax.mail.internet.MimeUtility.encodeText(CoreConfigConstant.sysNameEn);
        ...
        html.setContent(mailContent.getBody() +
                ...
                "<p style='float:left;margin-top: -3px;'>客服电话：4006-000-00<br/>" +
                "BCEX</p>", "text/html;charset=gbk");
